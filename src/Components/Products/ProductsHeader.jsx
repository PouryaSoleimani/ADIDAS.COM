...
const ProductsHeader = () => {
 ...
 return (
  <>
   ...
   <div className='flex z-10 bg-white items-center justify-start md:justify-between px-1 md:px-6 font-sans w-full'>
    {/* LEFT */}
    ...
    <div className='hidden md:flex'>
     <ul className=' tracking-tighter leading-tight flex space-x-6'>
      <li className='cursor-pointer hover:underline decoration-8 text-sm font-sans font-bold'><NavLink to='/products/all'>ALL</NavLink></li>
      <li className='cursor-pointer hover:underline decoration-8 text-sm font-sans font-bold'><NavLink to='/products/men'>MEN</NavLink></li>
      <li className='cursor-pointer hover:underline decoration-8 text-sm font-sans font-bold'><NavLink to='/products/women'>WOMEN</NavLink></li>
      <li className='cursor-pointer hover:underline decoration-8 text-sm font-sans font-bold'><NavLink to='/products/kids'>KIDS</NavLink></li>
      <li className='cursor-pointer hover:underline decoration-8 text-sm font-sans font-bold text-red-700 '><NavLink to='/products/sale'>SALE</NavLink></li>
      <li className='cursor-pointer hover:underline decoration-8 text-sm font-sans font-bold '><NavLink to='/products/jerseys'>JERSEYS</NavLink></li>
     </ul>
    </div>
    ...
    <div className='flex space-x-4 flex-shrink '>
     <div className="input-container -translate-x-4 -translate-y-1">
      <input type="search" name="text" className="input relative hidden md:flex" placeholder="search..." />
      <span className="icon">
       <BsSearch className='invisible md:visible translate-x-8 ' />
      </span>
     </div>
     ...
     <ul className='flex space-x-4 px-2'>
      {ISLOGGEDIN ? (
       ...
       <Link to='/signup' className='w-5 h-5 hidden md:inline'><FaRegUser className='w-6 h-6 font-bold cursor-pointer hover:text-zinc-500' /></Link>
      )}

      <li className='w-5 h-5 hidden md:inline'><TiHeartOutline className='w-6 h-6 font-bold cursor-pointer hover:text-zinc-500' /></li>
      <li className='w-5 h-5 hidden md:inline'><MdOutlineShoppingBag className='w-6 h-6 font-bold cursor-pointer hover:text-zinc-500' /></li>
     </ul>
    </div>
    {/* HAMBURGER MENU =========================================================================================================*/}
