 ...
 return (
  ...
  <div className='w-screen bg-[#ede734] h-[10rem] mt-0 flex items-center justify-center flex-wrap'>
   ...
   <div className='flex flex-col md:flex-row space-y-2 items-center justify-center space-x-4 md:space-x-10 my-auto'>
    ...
    <button className='button flex items-center justify-center w-[12rem] font-extrabold text-md h-[3.3rem] tracking-tighter whitespace-nowrap'><Link to={IsLoggedIn ? '/myadidas' : '/signup'}>SIGN UP FOR FREE <span>I'M IN</span></Link></button>
   </div>
  </div>
 )
}
