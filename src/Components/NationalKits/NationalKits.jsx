  ...
  return (
    <div>
      ...
      <div className='flex justify-end h-full flex-col pl-8 md:px-10 py-4 z-30 -translate-y-[8rem]  sm:-translate-y-[8rem]   md:-translate-y-[10rem] space-y-2'>
        ...
        <button className='button text-5xl font-extrabold tracking-tighter leading-tight whitespace-nowrap  w-[10rem] z-30'><Link to='/products/jerseys'>LET'S GO ! <span>LET'S GO !</span></Link></button>
      </div>
    </div>
  )
}
